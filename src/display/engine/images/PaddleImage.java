...
public class PaddleImage extends Image {
	private static final String DEFAULT_IMAGE = System.getProperty("user.dir") + "/src/game/breakout/assets/images/entities/paddle.png";
	 ...
	 */
    public PaddleImage(String fileName,
        int posX, int posY,
	 ...
	 * @param color The color of the graphical object (ignored but used to call the super constructor)
	 */
	public PaddleImage(int posX, int posY, int width, int height, Color color) {
