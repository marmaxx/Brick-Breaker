...
public class Ball extends Entity {
    ...
    public void handleWallCollision(){
		if ((getX() >= Breakout.getWallWidth() && getNextX() <= Breakout.getWallWidth()) || (getX() <= (GamePanel.SCREEN_FULL_SIZE.getWidth()-Breakout.getWallWidth()-DEFAULT_SIZE) && getNextX() >= (GamePanel.SCREEN_FULL_SIZE.getWidth()-Breakout.getWallWidth()-DEFAULT_SIZE))){
